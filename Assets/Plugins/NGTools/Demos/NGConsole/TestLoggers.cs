	...
	public class TestLoggers : MonoBehaviour
	{
		...
		protected virtual void	Awake()
		{
			...
			foreach (var assembly in assemblies)
			{
				...
				{
					if (assembly.FullName.StartsWith("Assembly-CSharp-Editor-firstpass") == true ||
						assembly.FullName.StartsWith("NGCoreEditor") == true ||
				...
				{
					if (assembly.FullName.StartsWith("Assembly-CSharp-Editor-firstpass") == true ||
						assembly.FullName.StartsWith("NGConsoleEditor") == true ||
						assembly.FullName.StartsWith("Assembly-CSharp-Editor") == true)
					{
						try
						{
