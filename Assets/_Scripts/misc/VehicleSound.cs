...
using Random = UnityEngine.Random;
    ...
    public class VehicleSound : MonoBehaviour
    {
        ...
        private DriveTrain Engine; // Reference to car we are controlling


        private void StartSound()
        {
            // get the carcontroller ( this will not be null as we have require component)
            Engine = GetComponent<DriveTrain>();
        ...
        private void Update()
        {
            ...
            if (m_StartedSound)
            {
                ...
                else
                {
                    ...
                    float accFade = Mathf.Abs(Engine.throttle);
                    float decFade = 1 - accFade;

                    // get the high fade value based on the cars revs
                    float highFade = Mathf.InverseLerp(0.2f, 0.8f, Engine.RPM/Engine.maxRPM);
